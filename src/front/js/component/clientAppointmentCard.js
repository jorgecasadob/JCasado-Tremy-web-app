                ...
                <div key={appointment.id} className="card mt-4" style={{ borderColor: 'rgb(194, 237, 249)' }}>
                    <div className="nextAppointment card-body">
                        <div className="d-flex align-items-center justify-content-center gap-3">
                            ...
                            <Col md={4}>
                                <h5 className="card-title mb-2">{appointment.fairy ? appointment.fairy.name : "No name was found on this order"}</h5>
                                ...
                                <p className="productsAppointmentCard">
                                    {appointment.products ? appointment.products.map((product) => {
                                        return(
