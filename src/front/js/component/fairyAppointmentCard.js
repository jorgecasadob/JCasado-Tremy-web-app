...
export const FairyAppointmentCard = () => {

    const { store, actions } = useContext(Context);

    useEffect(() => {

        actions.getClientAppointments();
                ...
                <div key={appointment.id} className="card mt-4" style={{ borderColor: 'rgb(194, 237, 249)' }}>
                    <div className="nextAppointment card-body">
                        <div className="d-flex align-items-center justify-content-center gap-3">
                            ...
                            <Col md={4}>
                                <h5 className="card-title mb-2">{appointment.client ? appointment.client.name : "No name was found on this order"}</h5>
                            ...
                            <Col md={3}>
                                ...
                                <Button href={`https://wa.me/${appointment.client && appointment.client?.phone}`} target="_blank" variant="whatsapp" className="button_whatsapp">
                                        <span> Chat </span>
...
export default FairyAppointmentCard;